...
LB = []
for file in range(1001, 1001+lb_total):
    filename = pot_files_path + str(file) + ".pot"
    print(filename)
    show = 999999
    fbegin = 171
    fn = 99999
...
with open(data_path + "dlb_total_" + str(lb_total) + "_dist_" + str(remove_dist_th) + "_ang_" + str(remove_ang_th),"wb") as f:
